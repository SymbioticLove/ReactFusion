...
// All of the fixed headers will stick to the top of the screen and shrink when the page is scrolled
// All headers are fully compatible across all modern devices
// Other types are different template style sets which can be further modified to your preferences
// Current templates:
...
const FusionFixedHeader = () => {
  ...
  return (
    ...
    >
      <div>
        <img src={fhdata.image} alt="Logo"></img>
      </div>
      <div>
        <h1>{fhdata.title}</h1>
